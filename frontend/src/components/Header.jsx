...
// ✅ If logged in → /profile, if not → /account
const handleUserClick = () => {
  if (user) {
    navigate("/profile")
  } else {
...
// ✅ Same logic for the nav dropdown "My Account" link
      ...
      <div className="bg-light py-2 border-bottom">
        <div className="container d-flex justify-content-between align-items-center small">
          ...
          <div className="d-flex align-items-center gap-4">
            ...
            >
              <FaUser />
              {/* ✅ Shows user name when logged in, Sign In when not */}
              <span>{user ? `Hello, ${user.name}` : "Hello, Sign In"}</span>
            </div>
            ...
            <ul className="navbar-nav mx-auto">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu shadow border-0 rounded-0">
                  ...
                  {/* ✅ My Account → /profile if logged in, /account if not */}
                  <li>
                    <a
